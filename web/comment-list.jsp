...
<html>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="createComment" method="get">
                        <input type="text" name="postId" id="commentPostId">
                    ...
                    <div class="comment-container">
                        <c:forEach var="comment" items="${listComments}">
                            <div class="comment">
                                <img src="" alt="User Image" width="40" height="40">
                                <div class="comment-content">
                                    ...
                                    <div class="comment-actions">
                                        ...
                                        <a href="comment-form.jsp?id=${comment.id}&postId=${comment.postId}&action=edit">Edit</a>
                                        <a href="comments/delete?id=${comment.id}&postId=${comment.postId}">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
                    <a href="comment-form.jsp?postId=${param.postId}&action=new">Add New Comment</a>
                </div>
            </div>
        </div>
    ...
    // Auto open comment modal if 'bat' is not null
   }
</script>
