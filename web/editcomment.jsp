                        ...
                        <div class="comment-content">
                            ...
                            <div class="comment-actions">
                                ...
                                <form action="updateComment" method="get" style="display: inline;">
                                    ...
                                    <textarea name="commentContent" rows="1"  style="flex: 1;overflow: hidden; padding: 10px; border: none; border-radius: 25px; outline: none; resize: none; font-size: 16px; background-color: #f5f5f5; color: #000;">${comment.noiDung}</textarea>
