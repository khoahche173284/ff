...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .back-button, .submit-button, .sign-out {
                padding: 10px 20px;
            ...
            .back-button:hover, .submit-button:hover, .sign-out:hover {
            ...
            <div class="form-container">
                <form action="adminaddproduct" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" step="1" value="${param.price}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="duration" name="duration" step="1" value="${param.duration}" required>
                    </div>
